...
grails {
    plugin {
        springsecurity {
            userLookup.userDomainClassName = 'cz.bublik.User'
            userLookup.authorityJoinClassName = 'cz.bublik.UserRole'
            authority.className = 'cz.bublik.Role'
...
// Start of Spring Security Rest plugin
